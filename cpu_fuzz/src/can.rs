/* Nicked from https://github.com/Robotics-BUT/DCMotor-firmware/blob/ac88b29e103717a73370015dfe0f3ce805ea8998/src/can.rs
 *
 * Copyright (c) 2020 Matous Hybl, Adam Ligocki, Brno University of Technology
 * MIT License
 */
use stm32f3_discovery::stm32f3xx_hal::gpio::gpiob::*;
use stm32f3_discovery::stm32f3xx_hal::gpio::{Alternate, AF4};
use stm32f3_discovery::stm32f3xx_hal::pac::can::TX;

/* Todo: refactor into som common board layer */
...
impl CANBus {
    pub fn new(can: stm32::CAN, rx: CanRx, tx: CanTx) -> Self {
        unsafe {

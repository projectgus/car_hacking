...
class IEB_153_TCS(PeriodicMessage):
    ...
    def __init__(self, car):
        super().__init__(
            car, 0x153, bytearray.fromhex("208010FF00FF0000"), 100, PCAN_CH
        )
...
class IEB_2A2(PeriodicMessage):
    ...
    def __init__(self, car):
        super().__init__(car, 0x2A2, bytes.fromhex("0500001C1000005E"), 100, PCAN_CH)
...
class IEB_331(PeriodicMessage):
    ...
    def __init__(self, car):
        super().__init__(car, 0x331, bytes.fromhex("F000000000000000"), 100, PCAN_CH)
...
class IEB_386_Wheel(PeriodicMessage):
    ...
    def __init__(self, car):
        super().__init__(car, 0x386, bytes.fromhex("0000000000400080"), 50, PCAN_CH)
...
class IEB_387_Wheel(PeriodicMessage):
    ...
    def __init__(self, car):
        super().__init__(car, 0x387, bytes.fromhex("0A0D000000210A00"), 50, PCAN_CH)
...
class IEB_507_TCS(PeriodicMessage):
    ...
    def __init__(self, car):
        super().__init__(car, 0x507, bytes.fromhex("00000001"), 10, PCAN_CH)
